#!/bin/bash
#
#BSUB -o /scratch/beegfs/monthly/mpmeurville/r2t/chuv/raw_reads/lsf_output/mapping/CHUV-output.%J
#BSUB -e /scratch/beegfs/monthly/mpmeurville/r2t/chuv/raw_reads/lsf_output/mapping/CHUV-error.%J
